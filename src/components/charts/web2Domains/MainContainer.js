        ...
        <div className='security-chart'>
            ...
            <div className='bar-graph-container'>
                <div className='bar-graph'>
                    <div><Web2Bar1 number='5' color={'#FFE176'} label="Look Alikes"/></div>
                    <div><Web2Bar1 number='6' color={'#FCAC95'} label="Total Encroachments"/></div>
                </div>
                <div className='bar-graph'>
                    <div><Web2Bar1 number='4' color={'#56EBFF'} label="Provided Redirections"/></div>
                    <div><Web2Bar1 number='10' color={'#1874FF'} label="Resolved Threats"/></div>
                </div>
            </div>
        </div>
    </div>
